...
public class RemovingHardCodingStringForObjectSizeUnit {

	private String kiloByteUnit = getResourceString(R.string.KiloByte_short);
	private Locale arabicLocale = new Locale("ar");

	@Rule
	public ActivityTestRule<MyProjectsActivity> mActivityRule = new ActivityTestRule<>(MyProjectsActivity.class);
	...
	@Test
	public void testUnitSizeStringForKB() {
		...
		onView(withId(R.id.details_right_bottom)).check(matches(withText(containsString(kiloByteUnit))));
	}
